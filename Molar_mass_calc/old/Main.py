...
class mywindow(QtWidgets.QMainWindow):
    ...
    def main_function(self):
        self.ui.Button_Check.clicked.connect(self.check_button)
        self.ui.Button_Edit.clicked.connect(self.edit_button)
        self.ui.Button_Clear.clicked.connect(self.check_button)
        self.ui.Button_Calculate.clicked.connect(self.calc_button)
        self.ui.Button_Send_to_Report.clicked.connect(self.write_button)
